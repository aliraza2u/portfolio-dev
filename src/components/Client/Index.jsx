...
const SLIDER_DATA = [
  {
    ...
    review:
      "ANWAR UL HAQ did a fantastic job across multiple projects. He is a great communicator, highly intelligent, and can understand complex requirements. With one project in particular that had some difficult logic, he dug right in and didn't stop until he had the solution figured out, which shows his resilience. I would definitely hire him again and I hope we get to work together again soon!",
  },
];
const SLIDER_DATA2 = [
  {
...
const SLIDER_DATA3 = [
  {
    ...
    subtitle: "New Jersey",
    review:
      "ANWAR UL HAQ was wonderful to work with. Very attentive and had a lot of great ideas for the project we were working on. One of the things I liked the most about Arslan is his willingness to learn and work on things a little out of his zone. Intelligent, hard-working guy. I would definitely recommend.",
  },
];
